...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JUzhishu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '网络拐角的杂货铺', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.juzhishu.life', // 网站地址
  ...
  WIDGET_PET_LINK:
        ...
        'https://cdn.jsdelivr.net/npm/model/penchan/penchan.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
